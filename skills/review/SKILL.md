---
name: review
description: Review checklist and evaluation criteria for Claude Code configuration files including CLAUDE.md, memory, skills, agents, commands, hooks, and MCP setup
---
